...
3. Use ActionView helpers like `link_to`, `button_to`, and `form_with` to help write HTML
...
- [form_with](https://guides.rubyonrails.org/form_helpers.html#binding-a-form-to-an-object)
